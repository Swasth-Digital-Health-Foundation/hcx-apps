...
const NotificationSection: React.FC<FaqItem> = ({ active, handleToggle, faq }) => {
    ...
    return (
        <div className="px-3 border-stroke border-b-2 dark:border-strokedark dark:shadow-none">
            {_.isEmpty(faq) ? <></> : <div>
                <button
                    className={`block w-full items-center justify-between gap-1.5 sm:gap-3 xl:gap-6 ${active === id ? 'active' : ''
                        }`}
                ...
                >
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            <div className="flex h-10.5 items-center justify-center rounded-md">
                                <svg
                                    className={`duration-200 ease-in-out dark:fill-white dark:stroke-white ${active === id ? 'rotate-90' : ''
                                        }`}
                                    width="8"
                                    height="16"
                                    viewBox="0 0 8 16"
