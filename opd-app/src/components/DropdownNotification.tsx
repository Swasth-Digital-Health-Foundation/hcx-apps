...
const DropdownNotification = () => {
    ...
    const notificationPayload = {
        "participant_role": "provider.hospital"
    }
    ...
    return (
        <li className="relative">
            ...
            >
                {!showMessageCount && <div className="absolute inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red ml-6 border-2 border-white rounded-full -top-2 -end-2 dark:border-gray-900">{notificationData.length}</div>}
                <span
