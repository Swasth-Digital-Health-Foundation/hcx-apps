      ...
      <div className='mb-2.5 rounded-lg border border-stroke bg-white p-2 px-3 shadow-default dark:border-strokedark dark:bg-boxdark'>
        <div className='mt-4'>
          ...
          <div className='flex space-x-1'>
            <div className="w-1/2 relative z-20 bg-white dark:bg-form-input">
              <label className="mb-2.5 block text-left font-medium text-black dark:text-white">
                Beneficiary Name: *
              </label>
            ...
            <div className="w-1/2 relative z-20 bg-white dark:bg-form-input">
              ...
              <div className="relative">
                <select
                  onChange={(e) => {
                    setSelectedPayor(e.target.value);
                  }}
                  required
                  className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-4 px-6 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark"
                >
                  <option value="">Select Payor</option>
                  {selectedUser && _.map(selectedUser.payorDetails, (payor, payorIndex) => (
                    <option key={payorIndex} value={payor?.payor}>{payor?.payor}</option>
                  ))}
                </select>
                <span className="absolute top-1/2 right-4 z-10 -translate-y-1/2 pointer-events-none">
                  <svg
        ...
        <div className="mt-4">
          ...
          <div className="relative z-20 bg-white dark:bg-form-input">
            ...
            >
              ...
              {selectedUser &&
                _.map(
                  selectedUser.payorDetails.filter(
                    (detail: any) => detail.payor === selectedPayor
                  ),
                  (ele: any, index: any) => {
                    return (
