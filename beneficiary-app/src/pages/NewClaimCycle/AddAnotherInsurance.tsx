...
const AddAnotherInsurance = (props: any) => {
    const { insurancePlanInputRef, setPayor, setInsuranceId } = props
    return (
        <div>
            {insurancePlanInputRef === 'add another' ? (
                <>
                    <h2 className="sm:text-title-xl1 mt-4 text-2xl font-bold text-black dark:text-white">
                        {strings.INSURANCE_DETAILS}
                    </h2>
                    <div className="flex flex-col gap-5.5 py-3">
                        <div>
...
export default AddAnotherInsurance